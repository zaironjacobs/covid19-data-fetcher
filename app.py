...
class App:
    ...
    def _download_csv(self):
        ...
        Will only download the last available data (09 March 2023)
        """
        ...
        url = (
            ...
            f"csse_covid_19_data/csse_covid_19_daily_reports/03-09-2023.csv"
        )
    ...
    def _create_country_models(self) -> List:
        ...
        last_updated_by_source_at_val = datetime.strptime(
            last_updated_by_source_at_val, "%Y-%m-%d %H:%M:%S"
        )
        last_updated_by_source_at_val = last_updated_by_source_at_val.strftime(
            "%Y-%m-%dT%H:%M:%SZ"
        )
    ...
    def _create_article_models(self) -> List:
        ...
        articles = []
        url = (
            f"https://newsapi.org/v2/everything?qInTitle=covid OR corona&apiKey={news_api_key}"
